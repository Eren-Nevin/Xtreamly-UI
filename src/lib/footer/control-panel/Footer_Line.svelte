...
<div class="bg-gray-800">
    ...
    >
        ...
        >
            <a class="text-gray-500" href="{facebookLink}">
                <svg
                    fill="currentColor"
            ...
            <a class="ml-3 text-gray-500" href={twitterLink}>
                <svg
                    fill="currentColor"
                    stroke-linecap="round"
                    stroke-linejoin="round"
            ...
            <a class="ml-3 text-gray-500" href={instagramLink}>
                <svg
                    fill="none"
                    stroke="currentColor"
                    stroke-linecap="round"
            ...
            <a class="ml-3 text-gray-500" href={linkedinLink}>
                <svg
                    fill="currentColor"
                    stroke="currentColor"
                    stroke-linecap="round"
